...
/**
 * Validates that required health data is present
 * Note: Reserved for future phases
 *
 * @param healthData - Health data from request
 * @returns Validation result
 */
// const validateHealthDataCompleteness = (healthData: AdviceRequest['healthData']): {
//   isValid: boolean;
...
//
//   if (!healthData.sleep) {
//     missingFields.push('sleep data');
//   }
//
//   if (!healthData.morningVitals) {
//     missingFields.push('morning vitals');
//   }
//
//   if (!healthData.yesterdayActivity) {
//     missingFields.push('yesterday activity');
//   }
//
//   return {
...
/**
 * Creates advice with fallback for insufficient data
 * Note: In Phase 7, this always returns mock data regardless of completeness
 * This function is reserved for future phases.
 */
// const generateAdviceWithFallback = (
//   request: AdviceRequest,
//   timeSlot: 'morning' | 'afternoon' | 'evening'
// ): AdviceResponse => {
//   const validation = validateHealthDataCompleteness(request.healthData);
//
//   // In Phase 7, we always return mock data
//   // Future phases will use this validation to adjust advice quality
//   if (!validation.isValid) {
//     console.log('Health data incomplete, using fallback advice:', {
//       missing: validation.missingFields,
//     });
//   }
//
//   return createMockAdviceForTimeSlot(request.userProfile.nickname, timeSlot);
// };
