 ...
 * @returns 英語: "Good Evening, John" / 日本語: "こんばんは太郎さん"
 */
export const getGreeting = (name?: string, locale: string = "en"): string => {
 ...
 * @param locale 言語コード ("en" | "ja")
 * @returns 英語: "Tuesday, January 7" / 日本語: "1月7日（火）"
 */
