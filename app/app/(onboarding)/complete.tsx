    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.description}>Let&apos;s find your rhythm.</Text>
          ...
          <View style={styles.calibrationBox}>
            ...
            <Text style={styles.calibrationDescription}>
              For the first {CALIBRATION_PERIOD_DAYS} days, Tempo will learn
              your unique patterns. Your score may show &quot;---&quot; during
              this time, but your data is being collected.
            </Text>
            ...
            <View style={styles.progressSection}>
              <View style={styles.progressHeader}>
                ...
                <Text style={styles.progressValue}>
                  0/{CALIBRATION_PERIOD_DAYS} days
                </Text>
              </View>
...
const TipItem: React.FC<{ emoji: string; text: string }> = ({
  emoji,
  text,
}): JSX.Element => (
