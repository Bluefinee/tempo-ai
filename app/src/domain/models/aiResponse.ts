...
export const FALLBACK_AI_RESPONSE: AIResponse = {
  todayInsight: {
    title: "New Day",
    summary:
      "今日も新しい1日が始まりました。身体の声に耳を傾けながら、自分のペースで過ごしましょう。データの分析は次回の起動時に改めて行います。",
    whyThisMatters: {
      hrv: {
        headline: "データを分析中",
    ...
    whatThisMeansForToday:
      "無理のない範囲で、今日のタスクに取り組みましょう。身体が疲れを感じたら、休息を優先してくださいね。",
  },
  todayOneThing: {
    icon: "breathing",
    action: "深呼吸で1日をスタート",
    ...
    time: null,
    whyThisAction:
      "深呼吸は自律神経を整え、1日の良いスタートを切る助けになります。どんなコンディションの日でも、深呼吸は心身のバランスを整える効果があります。",
